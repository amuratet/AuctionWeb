...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark auctionNavbar">
		...
		<div class="collapse navbar-collapse navFlex" id="navbarNav">
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a class="nav-link" href="/list">Enchères</a></li>
				<%
					if (isConnected) {
				%>
		...
		<div class="row">
			...
			<div class="col-sm-6 articleDisplay">
				<div class="card articleContent">
					...
					<div class="unArticle">
						<img src="<%=request.getContextPath()%>/images/computer.jpg"
							class="img-responsive" alt="Image">
						<p class="articleDescription">
							Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed non
							risus. Suspendisse lectus tortor, dignissim sit amet, adipiscing
							nec, ultricies sed, dolor. Cras elementum ultrices diam. <br>
							<a href="#" class="nomVendeur"> - <%=nomVendeur%> -
							</a>
						</p>
					</div>
	...
	<!-- FOOTER -->
	<footer
		class="container-fluid text-center bg-dark text-secondary auctionFooter">
